...
export default class {
    ...
    */
    decrypt(encryptedString) {
        return CryptoJS.AES.decrypt(encryptedString, this.passPhrase).toString(CryptoJS.enc.Utf8);
    }
    ...
    decrypt(encryptedString, passPhrase) {
        return CryptoJS.AES.decrypt(encryptedString, passPhrase).toString(CryptoJS.enc.Utf8);
    }
