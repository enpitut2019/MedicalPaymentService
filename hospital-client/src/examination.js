    ...
    */
    async getPatientInfo() {
        ...
        if (this.management.isHospital) {
            let patientPassPhrase = this.management.decrypt(patientInfo[2], this.management.passPhrase);
            patientData = this.management.decrypt(patientInfo[1], patientPassPhrase);
        } else {
            patientData = this.management.decrypt(patientInfo[1], this.management.passPhrase);
        }
